package kosa.subject.stream.problem.extreme;

import java.util.List;
import java.util.Map;

import kosa.subject.stream.problem.extreme.resources.Employee;
import kosa.subject.stream.problem.extreme.resources.Project;
